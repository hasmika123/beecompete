  ...
  return (
    <ToastProvider>
      <div className="flex min-h-dvh flex-col bg-background lg:flex-row">
        ...
        {/* Theme toggle floats at the screen's top-right (icon only), out of the sidebar. The
            surface + border keeps it legible over whatever content scrolls beneath it. */}
        <div className="fixed top-3 right-3 z-40 rounded-full border border-border bg-surface-raised shadow-sm">
          <ThemeToggle />
        </div>
      </div>
    </ToastProvider>
