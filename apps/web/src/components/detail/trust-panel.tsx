...
// once the org is claimed/verified, else BeeCompete's Curation Team) + provenance. Maintained-by wording
// is LOCKED — "maintained", never "managed".

const SOURCE_LABELS: Record<string, string> = {
  curated: 'Curated by BeeCompete',
...
export function TrustPanel({ competition }: { competition: CompetitionDetail }) {
  ...
  const maintainer = hostMaintained ? competition.organizer!.name : "BeeCompete's Curation Team";
